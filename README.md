...
```text
replicate_final.py        Exact enumeration, figures, tables, and LaTeX macros
validation_swaps.tex      Paper source
validation_swaps.pdf      Compiled paper
generated/                Reproducible figures, CSVs, and LaTeX fragments
...
The manuscript inputs all figures, tables, and repeated numerical results from these generated files.
